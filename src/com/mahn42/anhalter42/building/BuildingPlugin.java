...
public class BuildingPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        lBDesc.nameSensible = true;
        lRel = lBDesc.newRelatedTo("sign", BuildingDescription.RelatedPosition.Nearby, 1);
        lRel = lBDesc.newRelatedTo(new Vector( 30, 0, 0), "bottomright");
        lRel.materials.add(Material.AIR);
        lRel.minDistance = 2;
        lRel = lBDesc.newRelatedTo(new Vector( 0, 40, 0), "topleft");
        lRel.materials.add(Material.OBSIDIAN);
        lRel.minDistance = 2;
        lBDesc = lDesc.newBlockDescription("bottomright");
        lBDesc.materials.add(Material.OBSIDIAN);
        lRel = lBDesc.newRelatedTo(new Vector( 0, 40, 0), "topright");
        lRel.materials.add(Material.OBSIDIAN);
        lRel.minDistance = 2;
        lBDesc = lDesc.newBlockDescription("topleft");
        lBDesc.materials.add(Material.GLOWSTONE);
        lRel = lBDesc.newRelatedTo(new Vector( 30, 0, 0), "topright");
        lRel.materials.add(Material.OBSIDIAN);
        lRel.minDistance = 2;
        ...
        lDesc = lDetector.newDescription("Building.Monument.Zombie.Husk");
        lDesc.handler = lHandler;
        lDesc.typeName = "Zombie Monument";
        //lDesc.iconName = "tower";
        lDesc.circleRadius = 100;
        lDesc.influenceRadiusFactor = 100.0;
        lDesc.color = 0xFF8080;
        lDesc.fillStyleOpacity = 0.0;
        lBDesc = lDesc.newBlockDescription("top");
        lBDesc.materials.add(Material.NETHER_BRICK);
        lBDesc.detectSensible = true;
        lBDesc.nameSensible = true;
        lRel = lBDesc.newRelatedTo(new Vector( 2,-2, 2), "e11");
        lRel.materials.add(Material.NETHERRACK);
        ...
        lDesc = lDetector.newDescription("Building.Monument.Skeleton");
        lDesc.handler = lHandler;
        lDesc.typeName = "Skeleton Monument";
        //lDesc.iconName = "tower";
        lDesc.circleRadius = 100;
        lDesc.influenceRadiusFactor = 100.0;
        lDesc.color = 0x808080;
        lDesc.fillStyleOpacity = 0.0;
        lBDesc = lDesc.newBlockDescription("top");
        lBDesc.materials.add(Material.BONE_BLOCK);
        lBDesc.detectSensible = true;
        lBDesc.nameSensible = true;
        lRel = lBDesc.newRelatedTo(new Vector( 2,-2, 2), "e11");
        lRel.materials.add(Material.NETHERRACK);
        ...
        lDesc = lDetector.newDescription("Building.Monument.Spider");
        lDesc.handler = lHandler;
        lDesc.typeName = "Spider Monument";
        //lDesc.iconName = "tower";
        lDesc.circleRadius = 100;
        lDesc.influenceRadiusFactor = 100.0;
        lDesc.color = 0x8080FF;
        lDesc.fillStyleOpacity = 0.0;
        lBDesc = lDesc.newBlockDescription("top");
        lBDesc.materials.add(Material.MAGMA);
        lBDesc.detectSensible = true;
        lBDesc.nameSensible = true;
        lRel = lBDesc.newRelatedTo(new Vector( 2,-2, 2), "e11");
        lRel.materials.add(Material.NETHERRACK);
        ...
        lDesc.activate();
         ...
         lDesc = lDetector.newDescription("Building.Monument.Witch");
        lDesc.handler = lHandler;
        lDesc.typeName = "Witch Monument";
        //lDesc.iconName = "tower";
        lDesc.circleRadius = 100;
        lDesc.influenceRadiusFactor = 100.0;
        lDesc.color = 0xFF80FF;
        lDesc.fillStyleOpacity = 0.0;
        lBDesc = lDesc.newBlockDescription("top");
        lBDesc.materials.add(Material.DIAMOND_BLOCK);
        lBDesc.detectSensible = true;
        lBDesc.nameSensible = true;
        lRel = lBDesc.newRelatedTo(new Vector( 2,-2, 2), "e11");
        lRel.materials.add(Material.NETHERRACK);
